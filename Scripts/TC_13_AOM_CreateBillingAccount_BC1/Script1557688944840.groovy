...
response1 = WS.sendRequest(findTestObject('BillingAccount/CreateBillingAccount_Manually_Billcycle1_ParenRelationID1', [('billcycle') : GlobalVariable.billcycle
            , ('custID') : GlobalVariable.custID, ('billAcctID') : GlobalVariable.billAcctID, ('parentRelationID1') : GlobalVariable.parentRelationID1]))
