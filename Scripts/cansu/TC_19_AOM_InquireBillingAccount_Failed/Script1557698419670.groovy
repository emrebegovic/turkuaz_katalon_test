...
response1 = WS.sendRequest(findTestObject('BillingAccount/InquireBillingAccount', [('custID') : GlobalVariable.custID, ('billAcctID') : GlobalVariable.billAcctID]))
...
if (!(FaultMessageControl.contains('<FAULT_CODE>'))) {
	...
	println('\n***** There is no billAccount with : BILL_ACCT_ID: ' +GlobalVariable.billAcctID +'*****\n')
}
